...
public class ListViewViewModel<t> {
    ...
    public ListViewViewModel(ListView listview, AbstractAdapter adapter, IListViewVmDelegate<t> delegate){
        ...
        if(listview==null) Log.wtf(LOG_TAG, "ctor: arg violation listview can't be null");
        if(adapter==null) Log.wtf(LOG_TAG, "ctor: arg violation adapter can't be null");
        if(delegate==null) Log.wtf(LOG_TAG, "ctor: arg violation delegate can't be null");
